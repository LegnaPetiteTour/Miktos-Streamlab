...
class EnhancementService:
    ...
    def __init__(self):
        ...
        self._active_enhancements: Dict[str, str] = {}
    ...
    async def enable_enhancement(
        ...
        """
        logger.info(
            f"Enabling enhancement profile {profile_id} "
        ...
        try:
            ...
            if success:
                ...
                logger.error("Failed to enable enhancement")
    ...
    async def disable_enhancement(self, camera_id: str) -> bool:
        ...
        try:
            ...
            if success:
                ...
                logger.error("Failed to disable enhancement")
    ...
    async def update_profile_settings(
        ...
        for camera_id, active_profile_id in self._active_enhancements.items():
            if active_profile_id == profile_id:
                logger.info(
                    f"Reapplying updated profile to camera {camera_id}")
