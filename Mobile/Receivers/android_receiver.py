...
def main():
    ...
    print("   1. Open Miktos Camera app")
    print("   2. Enter your Mac IP address")
    print(f"   3. Port: {PORT}")
    print("   4. Tap START STREAMING\n")
    ...
    try:
        ...
        while True:
            ...
            if now - last_print >= 2.0:
                ...
                mb_received = bytes_received / 1_000_000
                stats = (
                    f"📊 {mb_received:.1f} MB | "
                    f"{mbps:.2f} Mbps | {elapsed:.0f}s"
                )
                print(stats)
                last_print = now
