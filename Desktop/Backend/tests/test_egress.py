...
class TestHealthMonitoring:
    ...
    async def test_health_monitoring_stops(self, egress_config):
        ...
        assert manager._monitor_task.done() or manager._monitor_task.cancelled()
...
class TestErrorHandling:
    ...
    async def test_connect_exception_handling(self):
        ...
        with patch.object(dest, 'logger') as mock_logger:
    ...
    async def test_health_check_exception_handling(self, rtmp_destination):
        ...
        with patch.object(rtmp_destination, '_get_average_metrics', side_effect=Exception("Test error")):
            try:
                health = await rtmp_destination.get_health()
