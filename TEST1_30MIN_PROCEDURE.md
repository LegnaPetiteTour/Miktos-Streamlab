...
### Manual Observations
**Record during test:**
- [ ] Any screen freezes (timestamp: ______)
- [ ] Any thermal warnings on status display (timestamp: ______)
- [ ] Any network interruptions (timestamp: ______)
...
- Final: ____%
- Drain: ____%
- Rate: ____% per minute

**Thermal:**
- Max Temp: ____°C
- Max State: ____ (OK/WARM/HOT/CRITICAL)

**Stream:**
- Uptime: ____% (_____ minutes)
- Interruptions: ____
